...
-- Run this BEFORE migration-all-phases.sql if you haven't run
-- migration-add-patients.sql and migration-clinical-features.sql
-- ============================================================
...
-- Column names match what the frontend code uses
-- ============================================================
...
-- Fix column names if the old migration was already run with different names
DO $$
BEGIN
...
-- ============================================================
-- 5. Expand appointments with clinical fields
-- ============================================================
...
-- ============================================================
-- 6. Expand session_notes with CPT & treatment tracking
-- ============================================================
...
-- ============================================================
-- 8. Exercise library: allow insert/update for authenticated users
-- ============================================================
DO $$ BEGIN
...
-- ============================================================
-- 9. Patient documents: RLS for documents and prescriptions tables
-- (Tables created in migration-all-phases.sql)
-- ============================================================
DO $$ BEGIN
...
-- ============================================================
-- 12. Profile fields for note signing
-- ============================================================
